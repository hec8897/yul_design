...
var handleDatepicker = function () {
    ...
    handleDateRangePicker = function () {
        $("#default-daterange").daterangepicker({
            ...
            $("#default-daterange input").val(t.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY"))
            ...
            $("#advance-daterange span").html(t.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY"))
        })
    },
    ...
    handleDateTimePicker = function () {
        $("#datetimepicker1").datetimepicker(), $("#datetimepicker2").datetimepicker({
            format: "LT"
        }), $("#datetimepicker3").datetimepicker(), $("#datetimepicker4").datetimepicker(), $("#datetimepicker3").on("dp.change", function (t) {
            $("#datetimepicker4").data("DateTimePicker").minDate(t.date)
        }), $("#datetimepicker4").on("dp.change", function (t) {
            $("#datetimepicker3").data("DateTimePicker").maxDate(t.date)
        })
    },
    handleBootstrapColorPalette = function () {
        $("#color-palette-1").colorPalette().on("selectColor", function (t) {
            $('[data-id="color-palette-1"]').val(t.color)
        });
        $("#color-palette-custom").colorPalette({
            colors: [
                ["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#EFF7F7", "#FFFFFF"]
            ]
        }).on("selectColor", function (t) {
            $('[data-id="color-palette-custom"]').val(t.color)
        })
    },
    ...
    handleClipboard = function () {
        new Clipboard(".btn").on("success", function (t) {
            $(t.trigger).tooltip({
                title: "Copied",
                placement: "top"
            }), $(t.trigger).tooltip("show"), setTimeout(function () {
                $(t.trigger).tooltip("destroy")
            }, 500)
        })
    },
